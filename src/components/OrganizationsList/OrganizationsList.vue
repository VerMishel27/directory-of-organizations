<template>
	<table class="organizations-list">
		<thead>
			<tr class="organizations-list__line organizations-list__line_border">
				<th class="organizations-list__column">
					<a
						class="organizations-list__filter-button"
		...
		<tbody>
			...
			<tr
				class="organizations-list__line"
			...
			>
				...
				<td class="organizations-list__column organizations-list__column_width">
					...
					>
						<img
							class="organizations-list__close-icon"
	...
	<div class="organizations-list__button-block">
		...
		>
			...
			>
			<img
				src="../../images/forward-icon-disabled.svg"
				alt="Назад"
				class="organizations-list__icon-btn organizations-list__icon-btn_rotate"
				:class="{ icon_disable: !disableBackButton }"
			>
	...
	methods: {
		...
		sortedList(name) {
			switch (name) {
				...
				case 'company': return this.organizations.sort(sortByCompany);
...
const sortByCompany = function (d1, d2) { return (d1.name.toLowerCase() > d2.name.toLowerCase()) ? 1 : -1; };
</script>